...
hash_benchmark!(hash_string_u8, 100u8);
hash_benchmark!(hash_string_u8_quad, (100u8, 10u8, 1u8, 200u8));
hash_benchmark!(hash_string_u32, 100u32);
hash_benchmark!(hash_string_u32_pair, (100u32, 10u32));
hash_benchmark!(hash_string_u64, 100u64);
hash_benchmark!(hash_string_u64_pair, (100u64, 10u64));
...
library_benchmark_group!(name = hash_int_group; benchmarks =
    ...
    hash_string_u8_quad,
    hash_string_u32,
    hash_string_u32_pair,
    hash_string_u64,
    hash_string_u64_pair,
);

iai_callgrind::main!(library_benchmark_groups =
    hash_string_group,
    hash_bytes_group,
    hash_int_group,
);
