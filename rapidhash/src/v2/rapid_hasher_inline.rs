...
/// #[cfg(feature = "v2")]
/// use rapidhash::v2::RapidInlineHasher;
///
...
/// #[cfg(feature = "v2")]
/// use rapidhash::v2::RapidInlineBuildHasher;
///
...
impl RapidInlineHasher {
    ...
    // #[inline(always)]
    // #[must_use]
    // const fn write_num<const N: u8>(mut self, i: u128) -> Self {
    //     if (self.sponge_len + N) <= 128 {
    //         self.sponge |= i << self.sponge_len;
    //         self.sponge_len += N;
    //     } else {
